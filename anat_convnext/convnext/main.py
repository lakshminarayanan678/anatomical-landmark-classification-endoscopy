...
def get_args_parser():
    ...
    # EMA gives us a moore stable version of model weights
    # An averahe of the models' weights over time
...
def main(args):
    ...
    #     dataset_val, _ = build_dataset(is_train=False, args=args)
        ...
        if args.eval_data_path:
            ...
            eval_args.data_path = args.eval_data_path
            print(f"Reading evaluation dataset from: {eval_args.data_path}")
            dataset_val, _ = build_dataset(is_train=False, args=eval_args)
        else:
            print(f"Reading evaluation dataset from: {args.data_path}/val")
            dataset_val, _ = build_dataset(is_train=False, args=args)
